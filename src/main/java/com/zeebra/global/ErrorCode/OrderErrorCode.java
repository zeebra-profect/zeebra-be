...
public enum OrderErrorCode implements ErrorCode {
	...
	INVALID_STATUS_TRANSITION("E400_INVALID_ORDER_STATUS_TRANSITION", HttpStatus.BAD_REQUEST,"유효하지 않은 상태 전이입니다."),
	...
	CANNOT_BE_REFUNDED("E422_CANNOT_BE_REFUNDED", HttpStatus.UNPROCESSABLE_ENTITY, "환불할 수 없는 상태입니다."),
