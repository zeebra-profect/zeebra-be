...
public class NotificationTest {
    ...
    public void createNotification_validInput_success() throws Exception {
        // given
    ...
    public void getNotificationById_validNotificationId_success() {
        ...
        NotificationResponse createdNotification = notificationService.createNotificationAsync(request).join();
