...
//        NotificationRequest request = new NotificationRequest(1L, NotificationType.TEST, null, null);
//
...
//        // given
//        Member mockMember = createMockMember(1L, "user1", "user1@abc.a");
//        NotificationRequest request = new NotificationRequest(1L, null, null, null);
//
//        when(memberRepository.findById(1L)).thenReturn(Optional.of(mockMember));
//
//        // when & then
...
//        // given
//        Member mockMember = createMockMember(1L, "user1", "user1@abc.a");
//        NotificationRequest request = new NotificationRequest(1L, NotificationType.TEST_OBJECT, new Object(), null);
//
...
//
//        // when
//        notificationService.createNotification(new NotificationRequest(1L, NotificationType.TEST_OBJECT, null, null));
//        notificationService.createNotification(new NotificationRequest(2L, NotificationType.TEST_OBJECT, null, null));
//        notificationService.createNotification(new NotificationRequest(3L, NotificationType.TEST_OBJECT, null, null));
//
//        // then
...
//        Notification notification = new Notification(memberId, type, url, null);
//
//        try {
